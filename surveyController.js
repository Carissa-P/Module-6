...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        res.render('showResults', {results: [q2, q1, q3, q4,q5,q6]});
        console.log([q2, q1, q3, q4, q5, q6]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "q2") && (json[key].length === 2 || json[key].length === 3||json[key].length === 4||json[key].length === 5)){
